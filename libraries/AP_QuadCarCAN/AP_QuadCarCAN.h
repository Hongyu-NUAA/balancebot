...
class AP_QuadCarCAN : public AP_CANDriver {
public:
  AP_QuadCarCAN() {
  ...
  void setCurrent(uint8_t id, int16_t _cur) { target_current[id] = _cur; }
  ...
  static AP_QuadCarCAN *get_quadcarcan(uint8_t driver_index);

  static AP_QuadCarCAN *get_singleton() { return _singleton; }

private:
  static AP_QuadCarCAN *_singleton;
